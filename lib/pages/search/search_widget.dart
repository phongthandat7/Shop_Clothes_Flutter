...
class _SearchWidgetState extends State<SearchWidget> {
  ...
  Future<void> _loadProductData() async {
    ...
    _selectedCategory = _allProducts.isNotEmpty ? _allProducts.first.catName : null;
    _selectedCategory = 'MEN';
    _filteredProductsByCate = _allProducts.where((product) => product.catName == _selectedCategory).toList();
    setState(() {});
  }
